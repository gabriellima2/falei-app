...
export const env = envSchema.parse({
	...
	BREATHING_EXERCISES_COLLECTION_NAME:
		process.env.EXPO_PUBLIC_BREATHING_EXERCISES_COLLECTION_NAME,
	GOALS_COLLECTION_NAME: process.env.EXPO_PUBLIC_GOALS_COLLECTION_NAME,
	POEMS_COLLECTION_NAME: process.env.EXPO_PUBLIC_POEMS_COLLECTION_NAME,
	TONGUE_TWISTER_COLLECTION_NAME:
		process.env.EXPO_PUBLIC_TONGUE_TWISTER_COLLECTION_NAME,
})
